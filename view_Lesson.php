 ...
 <?php
      ...
      ?>
<head>
  <title>View Lesson Learned</title>
...
?>
  ...
  <div class="card-header">
    ...
    height: 40%;width: 40%;">View Lesson Learned</h5>
  </div>
 ...
 <div class="form-group">
    ...
    name="Q1_What_was_done_well" disabled><?php echo $Q1_Whats; ?></textarea>
            </div>
        </div>
        <br>
  ...
  <textarea rows="5" cols="40"class="Q2"id="Q2_What_wasnt_done_well" 
  name="Q2_What_wasnt_done_well" disabled ><?php echo $Q2_Whats ; ?></textarea>
        </div>
    </div>
 ...
 <textarea rows="5" cols="40"id="Q3_Actions_taken" class="Q3" name="Q3_Actions_taken"disabled><?php echo $Q3_Actions ; ?></textarea>
...
<div class="form-group">
    <div class="input-group">
        ...
        name="Q4_What_else_could_be_improved" class="Q4"disabled><?php echo $Q4_else ; ?></textarea>
    </div>
</div>  
