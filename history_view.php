...
<?php 
  $selected = sqlsrv_query($con ,"SELECT *
   FROM [EPMKS].[dbo].[tbl_Projects_details_old] where project_id ='$project_id'");
...
//2
if($lastChar2 !== '.' && $lastChar_pdf2 != '.pdf'){
...
if($lastChar_pdf2 == '.pdf'){
echo'<div style="border: 1px solid lightgray;">PDF:
<a  class="input-group-addon clip " href="'.$output_query["Presales_solution"].'"download>'.$output_query["PO_PDF_1"].'</a>
</div>';}

if($lastChar2 == '.'){
  echo'<div  style="border: 1px solid lightgray;"></div>';
}
 //3 Marketing_approval
if($lastChar3 !== '.' && $lastChar_pdf3 != '.pdf'){
//if($lastChar3 !== '.'){
...
<img src="'.$output_query["Marketing_approval"].'"width="30" height="20">
</a></div>';}

if($lastChar_pdf3 == '.pdf'){
  echo'<div style="border: 1px solid lightgray;">PDF:
<a  class="input-group-addon clip " href="'.$output_query["Marketing_approval"].'"download>'.$output_query["Marketing_approval"].'</a>
</div>';
}
if($lastChar3 == '.'){
  echo'<div  style="border: 1px solid lightgray;"></div>';
...
////4  Extra_approvals
if($lastChar4 !== '.' && $lastChar_pdf4 != '.pdf'){
...
<img src="'.$output_query["Extra_approvals"].'" type="application/pdf" width="30" height="20">
</a></div>';}

if($lastChar_pdf4 == '.pdf'){
echo'<div style="border: 1px solid lightgray;">PDF:
<a  class="input-group-addon clip " href="'.$output_query["Extra_approvals"].'"download>'.$output_query["Extra_approvals"].'</a>
</div>';}
...
////5  HW_LOI
if($lastChar5 !== '.' && $lastChar_pdf5 != '.pdf'){
echo'<div  style="border: 1px solid lightgray;">HW_LOI :
<a class="input-group-addon clip" href='.$output_query["HW_LOI"].' download>
<embed src="'.$output_query["HW_LOI"].'" style="width:50px;">
</a></div>';}

if($lastChar_pdf5 == '.pdf'){
echo'<div style="border: 1px solid lightgray;">PDF:
<a  class="input-group-addon clip " href="'.$output_query["HW_LOI"].'"download>'.$output_query["HW_LOI"].'</a>
</div>';}
...
<img src="'.$output_query["Project_acceptance_1"].'" style="width:50px;"></a></div>';}
 ...
 if($lastCharspdf1 == '.pdf'){
echo'<div style="border: 1px solid lightgray;">Project_acceptance_1:
<a  class="input-group-addon clip " href="'.$output_query["Project_acceptance_1"].'"download>'.$output_query["Project_acceptance_1"].'</a>
</div>';}
...
if($lastChars2 !== '.' && $lastCharspdf2 != '.pdf'){
 ...
 if($lastCharspdf2 == '.pdf'){
echo'<div style="border: 1px solid lightgray;">Project_acceptance_2:
<a  class="input-group-addon clip " href="'.$output_query["Project_acceptance_2"].'"download>'.$output_query["Project_acceptance_2"].'</a>
</div>';}
if($lastChars2 == '.'){
   echo'<div  style="border: 1px solid lightgray;"></div>';}

//3 
if($lastChars3 !== '.' && $lastCharspdf3 != '.pdf'){
 ...
 <img src="'.$output_query["Project_acceptance_3"].'" style="width:50px;">
  ...
  if($lastCharspdf3 == '.pdf'){
echo'<div style="border: 1px solid lightgray;">Project_acceptance_3:
<a  class="input-group-addon clip " href="'.$output_query["Project_acceptance_3"].'"download>'.$output_query["Project_acceptance_3"].'</a>
</div>';}

if($lastChars3 == '.'){
   echo'<div  style="border: 1px solid lightgray;"></div>';
}
//4 Project_acceptance_4
if($lastChars4 !== '.' && $lastCharspdf4 != '.pdf'){
 ...
 if($lastCharspdf4 == '.pdf'){
echo'<div style="border: 1px solid lightgray;">Project_acceptance_4:
<a  class="input-group-addon clip " href="'.$output_query["Project_acceptance_4"].'"download>'.$output_query["Project_acceptance_4"].'</a>
</div>';}
if($lastChars4 == '.'){
  echo'<div   style="border: 1px solid lightgray;"></div>';
}
//5 
if($lastChars5 !== '.' && $lastCharspdf5 != '.pdf'){
...
if($lastCharspdf5 == '.pdf'){
echo'<div style="border: 1px solid lightgray;">Project_acceptance_5 :
<a  class="input-group-addon clip " href="'.$output_query["Project_acceptance_5"].'"download>'.$output_query["Project_acceptance_5"].'</a>
</div>';}
  if($lastChars5 == '.'){
   echo'<div  style="border: 1px solid lightgray;"></div>';
}
