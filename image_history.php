...
$rows .='<td class=" " style="border: 1px solid lightgray;">'.$output_query["project_name"].'</td>';
if($output_query["delivery_date"]->format('Y-m-d') == '1900-01-01'){
  $rows .='<td class="" style="border: 1px solid lightgray;"></td>';
}else{
$rows .='<td class="" style="border: 1px solid lightgray;">'.$output_query["delivery_date"]->format('Y-m-d').'</td>';}
...
if($lastChar2 !== '.'){
$rows .='<td style="border: 1px solid lightgray;">
<a class="input-group-addon clip" href='.$output_query["PO_PDF_2"].' download>
<img src="'.$output_query["PO_PDF_2"].'" style="width:50px;">
</a></td>';}
...
if($lastChar3 !== '.'){
$rows .='<td style="border: 1px solid lightgray;">
<a class="input-group-addon clip" href='.$output_query["PO_PDF_3"].' download>
<img src="'.$output_query["PO_PDF_3"].'" style="width:50px;">
</a></td>';}
...
if($lastChars !== '.'){
$rows .='<td style="border: 1px solid lightgray;"><a class="input-group-addon clip" href='.$output_query["Project_acceptance_1"].' download>
<img src="'.$output_query["Project_acceptance_1"].'" style="width:50px;">
</a></td>';}
...
if($lastChars2 !== '.'){
$rows .='<td class="" style="border: 1px solid lightgray;width:2%;"><a class="input-group-addon clip" href='.$output_query["Project_acceptance_2"].' download>
...
if($lastChars3 !== '.'){
$rows .='<td class="" style="border: 1px solid lightgray;width:2%;"><a class="input-group-addon clip" href='.$output_query["Project_acceptance_3"].' download>
<img src="'.$output_query["Project_acceptance_3"].'" style="width:50px;"></a></td>';}
if($lastChars3 == '.'){
  $rows .='<td  style="border: 1px solid lightgray;"></td>';
}
if($lastChars4 !== '.'){
$rows .='<td class="" style="border: 1px solid lightgray;width:2%;"><a class="input-group-addon clip" href='.$output_query["Project_acceptance_4"].' download>
<img src="'.$output_query["Project_acceptance_4"].'" style="width:50px;"></a></td>';}
if($lastChars4 == '.'){
  $rows .='<td  style="border: 1px solid lightgray;"></td>';
}

if($lastChars5 !== '.'){
  $rows .='<td class="" style="border: 1px solid lightgray;width:2%;"><a class="input-group-addon clip" href='.$output_query["Project_acceptance_5"].' download>
  <img src="'.$output_query["Project_acceptance_5"].'" style="width:50px;"></a></td>';}
  if($lastChars5 == '.'){
  $rows .='<td  style="border: 1px solid lightgray;"></td>';
}
